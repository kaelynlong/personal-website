  ...
  const projects = [
    {
      ...
      longDesc: "Developed a dynamic web app using ReactJS, Flask, and custom REST APIs, emulating Instagram features like photo uploads, likes, comments, user following, and session management. Includes infinite scrolling and was deployed to AWS for scalability.",
